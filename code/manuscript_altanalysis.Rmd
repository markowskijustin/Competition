...
strat.temp$Outcome <- rep(c("Composite Quality of Care, %", "Total Patients Served, No.","Financial resilience,\nAltman’s Z Score", "Patient-to-Staff Ratio","Average prevalence of\nselect chronic conditions, %","Intensity", "Medicaid, %","Uninsured, %","CostPerPat","Quick Ratio, %","Months of Cash Available", "Revenue-to-Expenses, Ratio %","Liabilities-to-Assets, Ratio %","Staff, No.","Closure, Acquisition or\nloss of FQHC status, %"), 2)
